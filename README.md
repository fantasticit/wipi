...
本项目比较简单，一定程度上适合入门。您可以学到如何使用`koa2`开发接口和如何使用`vue`开发单页面，由于本人对`react`不熟练，故本项目的`fe`相关代码可能只适合看看`react`基本使用方法。谢谢，欢迎`star`。我的另一个类似项目，[点击前往](https://github.com/hyiron/plog)。
