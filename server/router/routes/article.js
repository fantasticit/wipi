...
module.exports = router => {
  ...
  // 
  router.get('/article/tags', ArticleController.article.getArticleTags)        // 获取文章标签
  ...
  router.delete('/article/:id', ArticleController.article.deleteArticle)       // 删除文章
   // 文章阅读量
  router.patch('/article/readingQuantity/:id', ArticleController.article.updateArticleReadingQuantity)
}
